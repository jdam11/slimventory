...
class ProxmoxClient:
    ...
    def _request_json(
        ...
        *,
        ...
        with request.urlopen(req, context=self._ssl_context(), timeout=self.timeout) as resp:  # nosemgrep: python.lang.security.audit.dynamic-urllib-use-detected.dynamic-urllib-use-detected
